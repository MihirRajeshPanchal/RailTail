...
export default function Cleanliness() {
  ...
  const handleSubmit = () => {
    ...
    fetch(`http://127.0.0.1:5000/add_complaint/cleanliness`, {
      method: 'POST',
      headers: {
              ...
              <Box
                ...
                <VStack spacing={5}>
                  <FormControl isRequired>
                    <FormLabel>Enter Station Name</FormLabel>
                    ...
                    <InputGroup>
                      ...
                      type="text" 
                      name="station" 
                      value={formData.station} // Bind value to state
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      type="text" 
                      name="line" 
                      value={formData.line} // Bind value to state
                      onChange={handleInputChange} // Handle input change
